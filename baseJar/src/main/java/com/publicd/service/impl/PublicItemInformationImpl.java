...
public class PublicItemInformationImpl implements com.publicd.service.IPublicItemInformation {
    ...
    @Override
    public PublicItemInformation selectItemInformationBySKUAndUserId(String sku, List<Long> ebays) {
        PublicItemInformationExample example=new PublicItemInformationExample();
        PublicItemInformationExample.Criteria cr=example.createCriteria();
        cr.andSkuEqualTo(sku);
    ...
    @Override
    public void importItemInformation(InputStream file ,String fileName) throws Exception {
    ...
    private void importExcel2003(InputStream inputStream) throws Exception{
        ...
        for(int i=0;i<total;i++){
            ...
            for(int j=1;j<=sheet.getLastRowNum();j++){
                ...
                List<UsercontrollerUserExtend> ebayAcounts= systemUserManagerService.queryAllUsersByOrgID("yes");
                List<Long> ebays=new ArrayList<>();
                if(ebayAcounts!=null&&ebayAcounts.size()>0){
                    for(UsercontrollerUserExtend ebay:ebayAcounts){
                ...
                PublicItemInformation itemInformation1=selectItemInformationBySKUAndUserId(sku,ebays);
