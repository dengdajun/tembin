...
public interface ITradingFeedBackDetail {
    ...
    void saveTradingFeedBackDetailMy(TradingFeedBackDetail tradingFeedBackDetail);
    ...
    FeedBackReportQuery selectFeedBackEbayAccountReportList(Map map);

    List<TradingFeedBackDetail> selectClientAssessFeedBackList(Map m, Page page);

    TradingFeedBackDetail selectByFeedBackId(long id);
}
