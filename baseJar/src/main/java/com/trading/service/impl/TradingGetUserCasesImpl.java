...
public class TradingGetUserCasesImpl implements com.trading.service.ITradingGetUserCases {
    ...
    @Override
    public List<TradingGetUserCases> selectGetUserCasesByTransactionId(String transactionid,Long ebayId) {
    ...
    @Override
    public List<TradingGetUserCases> selectGetUserCasesByHandled(List<UsercontrollerUserExtend> orgUsers) {
