...
public class TradingInternationalShippingServiceOptionDocImpl implements com.trading.service.ITradingInternationalShippingServiceOptionDoc {
    ...
    @Override
    public TradingInternationalshippingserviceoptionDoc selectById(long id){
        return this.tradingInternationalshippingserviceoptionDocMapper.selectByPrimaryKey(id);
    }

    @Override
    public void svaeDoc(TradingInternationalshippingserviceoptionDoc tradingInternationalshippingserviceoptionDoc){
        if(tradingInternationalshippingserviceoptionDoc.getId()!=null){
            this.tradingInternationalshippingserviceoptionDocMapper.updateByPrimaryKeySelective(tradingInternationalshippingserviceoptionDoc);
        }else{
            this.tradingInternationalshippingserviceoptionDocMapper.insertSelective(tradingInternationalshippingserviceoptionDoc);
        }
    }

    @Override
    public TradingInternationalshippingserviceoptionDoc selectByDocidSourceId(long docid,long sourceid){
        TradingInternationalshippingserviceoptionDocExample tde = new TradingInternationalshippingserviceoptionDocExample();
        tde.createCriteria().andDocIdEqualTo(docid).andSourceIdEqualTo(sourceid);
        List<TradingInternationalshippingserviceoptionDoc> li = this.tradingInternationalshippingserviceoptionDocMapper.selectByExample(tde);
