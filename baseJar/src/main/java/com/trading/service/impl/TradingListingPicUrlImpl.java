...
public class TradingListingPicUrlImpl implements com.trading.service.ITradingListingPicUrl {
    ...
    @Override
    public List<TradingListingpicUrl> selectByUrl(String url){
        TradingListingpicUrlExample tlue = new TradingListingpicUrlExample();
        tlue.createCriteria().andUrlEqualTo(url);
        return this.tradingListingpicUrlMapper.selectByExample(tlue);
    }

    @Override
    public TradingListingpicUrl queryByid(Long id){
        return this.tradingListingpicUrlMapper.selectByPrimaryKey(id);
    }
    ...
    @Override
    public void deltelById(Long id){
        this.tradingListingpicUrlMapper.deleteByPrimaryKey(id);
    }
}
