...
public interface ITradingItem {
    ...
    Item toItemByTradingItem(TradingItemWithBLOBs tradingItem) throws Exception;
    ...
    TradingItemWithBLOBs selectByTitleSkuEbayAccount(String sku, String title, String ebayAccount,String listingType,String site);

    TradingItemWithBLOBs selectApplitionData(String appstr);

    void updateTradingItem(Item item, TradingItemWithBLOBs tradingItem,String id) throws Exception;
    ...
    TradingItem selectItemBySkuAndUserId(String sku,List<UsercontrollerUserExtend> orgUsers);

    List<TradingItemWithBLOBs> selectByEbayAccount(String ebayAccount);

    List<ItemQuery> selectByItemIdList();
}
