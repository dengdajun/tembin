...
public interface ITradingMessageGetmymessage {
    ...
    List<TradingMessageGetmymessage> selectMessageGetmymessageByMessageId(String messageID,Long ebayId);
    ...
    List<TradingMessageGetmymessage> selectMessageGetmymessageByReplied(List<UsercontrollerUserExtend> orgUsers);
