...
public interface ITradingShippingServiceOptionsDoc {
    ...
    TradingShippingserviceoptionsDoc selectById(long id);

    void saveDoc(TradingShippingserviceoptionsDoc tradingShippingserviceoptionsDoc);

    TradingShippingserviceoptionsDoc selectByDocidSourceid(long docid, long sourceid);
}
