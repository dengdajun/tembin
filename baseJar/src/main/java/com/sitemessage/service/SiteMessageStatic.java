...
public class SiteMessageStatic {
    ...
    static {
        ...
        messageMap.put("update_listing_item_message","更新在线刊登");
        messageMap.put("feed_back_message","意见反馈信息");
        messageMap.put("listing_error_message","立即刊登出错消息");
    }
    ...
    *//**刊登失败的消息类型*//*
    ...
    /**更新在线刊登消息类型*/
    public static final String UPDATE_LISTING_ITEM_MESSAGE="update_listing_item_message";
    /**更新在线刊登Bean*/
    public static final String UPDATE_LISTING_ITEM_BEAN="update_listing_item_bean";
    /**上传图片的消息类型*/
    ...
    /**立即刊登报错，消息通知*/
    public static final String LISTING_ERROR_MESSAGE="listing_error_message";
