...
public class TradingInventoryComplementImpl implements com.complement.service.ITradingInventoryComplement {
    ...
    @Override
    public TradingInventoryComplement selectBySkuOrEbayAccount(String sku,long ebayAccountId){
        TradingInventoryComplementExample tice = new TradingInventoryComplementExample();
        tice.createCriteria().andItemSkuEqualTo(sku).andEbayIdEqualTo(ebayAccountId);
