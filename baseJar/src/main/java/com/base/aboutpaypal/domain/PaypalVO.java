...
public class PaypalVO {
    ...
    private String errCode;//失败后的错误码

    private String payer;
    private String paypalcountryname;
    private String paypalname;
    private String paypalpostalcode;
    private String paypalstreet1;
    private String paypalstreet2;
    private String paypalcityname;
    ...
    public String getPaypalcityname() {
        return paypalcityname;
    }

    public void setPaypalcityname(String paypalcityname) {
        this.paypalcityname = paypalcityname;
    }

    public String getPaypalcountryname() {
        return paypalcountryname;
    }

    public void setPaypalcountryname(String paypalcountryname) {
        this.paypalcountryname = paypalcountryname;
    }
    ...
    public String getPaypalpostalcode() {
        return paypalpostalcode;
    }

    public void setPaypalpostalcode(String paypalpostalcode) {
        this.paypalpostalcode = paypalpostalcode;
    }
    ...
    public void setPaypalstreet1(String paypalstreet1) {
        this.paypalstreet1 = paypalstreet1;
    }
    ...
    public void setPaypalstreet2(String paypalstreet2) {
        this.paypalstreet2 = paypalstreet2;
    }
