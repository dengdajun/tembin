...
public interface TradingGetUserCasesMapper {
     ...
     * @mbggenerated
     */
    List<TradingGetUserCases> selectByExampleWithBLOBs(TradingGetUserCasesExample example);
     ...
     * @mbggenerated
     */
    int updateByExampleWithBLOBs(@Param("record") TradingGetUserCases record, @Param("example") TradingGetUserCasesExample example);
     ...
     * @mbggenerated
     */
    int updateByPrimaryKeyWithBLOBs(TradingGetUserCases record);
