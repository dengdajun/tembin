...
/**获取token*/
  ...
  */
    ...
    //ask ebay
    public static  String escalateToCustomerSupport(String token,String caseid,String casetype,String escalationReason,String comments){
      /*  String xml="<?xml version=\"1.0\" encoding=\"utf-8\"?>" +
                ...
                "   </caseId>"+
                "   <escalationReason>" +
                "      <sellerSNADReason>"+escalationReason+"</sellerSNADReason>" +
                "   </escalationReason>" +
...
*/
         String xml="<?xml version=\"1.0\" encoding=\"utf-8\"?>\n" +
                ...
                "  </caseId>\n" +
                "  <comments>"+comments+"</comments>\n";
        if(casetype.contains("SNAD")){
            xml+=  "  <escalationReason>\n" +
                    "    <sellerSNADReason>"+escalationReason+"</sellerSNADReason>\n"+
                    "  </escalationReason>\n";
        }else if(casetype.contains("INR")){
            xml+=  "  <escalationReason>\n" +
                    "    <sellerINRReason>"+escalationReason+"</sellerINRReason>\n"+
                    "  </escalationReason>\n";
        }
        xml+="</escalateToCustomerSupportRequest>";
        return xml;
    }
