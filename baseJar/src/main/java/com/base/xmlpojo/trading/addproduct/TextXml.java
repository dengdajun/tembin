...
*/
        ...
        System.out.println(StringEscapeUtils.unescapeXml(HtmlUtils.htmlEscape("Virtual Reality 3D Video Glasses for 4-6&quot; inch Smartphones Google Cardboard")));
        System.out.println(StringEscapeUtils.unescapeXml(StringEscapeUtils.unescapeHtml("Virtual Reality 3D Video Glasses for 4-6\" inch Smartphones Google Cardboard")));
        //System.out.println("LCD Touch Digitizer for Garmin Nuvi n&uuml;vi 1450 1450T 1490 1490T 1450LMT 1490LMT".length());
        /*Map m = new HashMap();
        m.put("aa","1");
        m.put("bb","2");
        Set set = m.keySet(); //key装到set中
        Iterator it = set.iterator(); //返回set的迭代器 装的key值
        while(it.hasNext()){
            System.out.println(it.next());
            *//*String value = (String)m.get((Integer)it.next());
            System.out.println(it.next()+" "+value);*//*
        }*/
        //System.out.println(StringEscapeUtils.unescapeXml(StringEscapeUtils.unescapeHtml("Touch Screen Digitizer Glass Replacement for Allwinner A10 A13 7&apos;&apos; Tablet")));
