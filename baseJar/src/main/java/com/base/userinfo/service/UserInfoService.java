...
public interface UserInfoService {
    ...
    /**查询邀请码*/
    String queryInvitationCode(String code);

    /**将邀请码标记为已使用*/
    void updateInvitationCodeStat(String code);

    /**生成邀请码*/
    void createCode();

    List<UsercontrollerEbayAccount> selectByEbayName(String ebayName);

    void delEbayid(Long ebayID);
}
