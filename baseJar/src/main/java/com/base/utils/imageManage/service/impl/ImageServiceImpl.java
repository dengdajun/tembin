...
public class ImageServiceImpl implements com.base.utils.imageManage.service.ImageService {
    ...
    //美国图片服务器
    public static final String usFtpServerIP="198.11.179.206";
    public static final String usFtpServerUser="uspicman";
    public static final String usFtpServerPassword="tembinpic";
    ...
    public String getImageUserDir(){
        ...
        return ((Long)sessionVO.getId()).toString();
