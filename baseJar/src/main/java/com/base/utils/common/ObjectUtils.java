...
public class ObjectUtils {
    ...
    /**spring获取一个实体类所有的字段{字符串}，包括被继承的*/
    public static  <T> List<String> getClassAllFieldNames(T t){
        List<String> ls=new ArrayList<>();
        PropertyDescriptor[] x= org.springframework.beans.BeanUtils.getPropertyDescriptors(t.getClass());
        for (PropertyDescriptor p : x){
    ...
    /**复制inputstream*/
    public static List<InputStream> copyInputStream(InputStream is) throws Exception{
