...
public class MainTaskStaticParam {
    ...
    static {
        SOME_MULIT_TASK.put("Test_Test_test",1);
        ...
        SOME_MULIT_TASK.put(MainTask.SYNCHRONIZE_GET_ORDERS_BUYER_PAYPAL_ACOUNT,2);
        SOME_MULIT_TASK.put(MainTask.SYNCHRONIZE_GET_ORDERS_SELLER_TRANSACTION_TIMER,2);
    }
        /**定义一个抓订单需要的ebay帐号队列*/
        ...
        /**获取买家paypal账号的队列*/
        public final static BlockingQueue<TradingOrderGetOrders> CATCH_OEDER_BUYER_PAYPAL_ACCOUNT_QUEUE=new ArrayBlockingQueue<TradingOrderGetOrders>(10000);

        /**获取外部交易的队列*/
        public final static BlockingQueue<TaskGetOrdersSellerTransaction> CATCH_SELLER_TRANSACTION_QUEUE=new ArrayBlockingQueue<TaskGetOrdersSellerTransaction>(10000);
        ...
        static {
            ...
            doList.add(MainTask.SYNCHRONOUS_SHIPPING_BASE_DATA);
            ...
            doList.add(MainTask.SYNCHRONIZE_GET_ORDERS_BUYER_PAYPAL_ACOUNT);
            doList.add(MainTask.CHECK_EBAY_STATUS_DESC);
            doList.add(MainTask.SET_EBAY_NOTICE_TASK);
            doList.add(MainTask.CHECK_EBAY_ACCOUNT_DESC);
            doList.add(MainTask.ItemSpecificsRun);
            doList.add(MainTask.GET_PROMOTIONAL_SALE_DETAILS);
            doList.add(MainTask.RE_LIST_ITEM);
            doList.add(MainTask.GetStoreCateGory);
            doList.add("Test_Test_test");
    }
    /**定义各个任务的间隔时间*/
    public static final Map<String,Integer> SOME_CRTIMEMINU=new HashMap<String, Integer>();
    static {
        SOME_CRTIMEMINU.put(MainTask.SYNCHRONIZE_GET_ORDERS_ACCOUNT_TIMER,5);//获取订单交易费信息
        SOME_CRTIMEMINU.put(MainTask.SYNCHRONIZE_GET_MESSAGES_TIMER,10);//获取抓取message
        SOME_CRTIMEMINU.put(MainTask.SYNCHRONIZE_GET_USER_CASES_TIMER,10);//获取抓取case
        SOME_CRTIMEMINU.put(MainTask.SYNCHRONIZE_FEED_BACK_TIMER,35);//获取抓取feedback评价
        SOME_CRTIMEMINU.put(MainTask.CHECK_EBAY_STATUS_DESC,1000);//检查ebay帐号的状态，是否被停用
        SOME_CRTIMEMINU.put(MainTask.SET_EBAY_NOTICE_TASK,1000);//开通帐号的通知功能
        SOME_CRTIMEMINU.put(MainTask.CHECK_EBAY_ACCOUNT_DESC,1000);//获取订ebay帐号信息
        SOME_CRTIMEMINU.put(MainTask.SYNCHRONIZE_GET_ORDERS_BUYER_PAYPAL_ACOUNT,10);//获取订单paypal信息
        SOME_CRTIMEMINU.put(MainTask.SYNCHRONIZE_GET_TIMER_ORDERS,10);//获取订单信息

    }


    /**增加一个运行期间的黑名单*/
    public static final Map<String,String> blackBill=new HashMap<String, String>();
