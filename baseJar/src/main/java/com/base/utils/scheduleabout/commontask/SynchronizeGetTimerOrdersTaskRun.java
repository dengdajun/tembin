...
public class SynchronizeGetTimerOrdersTaskRun extends BaseScheduledClass implements Scheduledable {
    ...
    public void run(){
        ...
        if (MainTaskStaticParam.CATCH_ORDER_QUEUE.isEmpty()&&!"0".contentEquals(mark)){
            return;
        }
    ...
    public Integer crTimeMinu() {
     /*   ITaskGetOrders iTaskGetOrders = (ITaskGetOrders) ApplicationContextUtil.getBean(ITaskGetOrders.class);
        ...
        Integer c=MainTaskStaticParam.SOME_CRTIMEMINU.get(MainTask.SYNCHRONIZE_GET_TIMER_ORDERS);
        return (c==null||c==0)?10:c;
    }
