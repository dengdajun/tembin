...
public class TaskPool {
    ...
    public final static BlockingQueue<TradingGetDispute> togos1=new ArrayBlockingQueue<TradingGetDispute>(600);
    public final static String[] togosBS1=new String[1];
    static {
        togosBS1[0]="0";
    }
