...
public class HttpClientUtil {
	...
	public static HttpClient getHttpClient() {
		...
		params.setIntParameter(CoreConnectionPNames.CONNECTION_TIMEOUT,
				120 * 1000);
		params.setIntParameter(CoreConnectionPNames.SO_TIMEOUT, 120 * 1000);
	...
	public static HttpClient getHttpsClient() {
		...
		params.setIntParameter(CoreConnectionPNames.CONNECTION_TIMEOUT,
				300 * 1000);
		params.setIntParameter(CoreConnectionPNames.SO_TIMEOUT, 300 * 1000);
		HttpProtocolParams.setVersion(params, HttpVersion.HTTP_1_1);
	...
	public static String post(HttpClient httpClient, String url, String content,
							  String encode,List<BasicHeader> header)
			throws Exception {
		String ret = "";
		try {
			...
			if (content == null) {
				...
				//nvps.add(new BasicNameValuePair("t","noPair"));
	...
	//带有url参数的post
	public static String postWithParam(HttpClient httpClient, String url,
