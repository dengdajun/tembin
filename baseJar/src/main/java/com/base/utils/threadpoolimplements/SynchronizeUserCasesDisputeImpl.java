    ...
    public <T> void doWork(String res, T... t) {
        ...
        try {
            ...
            if ("Success".equalsIgnoreCase(ack)) {
                ...
                List<TradingGetDispute> disputeList=iTradingGetDispute.selectGetDisputeByTransactionId(dispute.getEbayId(),dispute.getTransactionid());
            ...
            logger.error("解析xml出错,请稍后到ebay网站确认结果17"+res,e);
            return;
        }
    }
