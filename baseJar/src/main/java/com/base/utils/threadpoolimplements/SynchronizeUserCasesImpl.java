                ...
                for(int i=1;i<=totalPage;i++) {
                    ...
                    if ("Success".equalsIgnoreCase(ack)||"Warning".equalsIgnoreCase(ack)) {
                        ...
                        for (TradingGetUserCases userCases : userCasesList) {
                            List<TradingGetUserCases> casesList = iTradingGetUserCases.selectGetUserCasesByTransactionId(userCases.getTransactionid(), userCases.getEbayId());
                            ...
                            if (caseType.contains("EBP")) {
                                ...
                                if ("Success".equalsIgnoreCase(ebpAck)) {
                                    ...
                                    List<TradingGetEBPCaseDetail> lists = iTradingGetEBPCaseDetail.selectGetEBPCaseDetailByTransactionId(userCases.getEbayId(),caseDetail.getTransactionid());
                                    ...
                                    caseDetail.setEbayId(userCases.getEbayId());
                            ...
                            /*Map<String, String> resMap = addApiTask.exec(d, xml, "https://api.ebay.com/ws/api.dll");*/
                                ...
                                if ("Success".equalsIgnoreCase(Ack)) {
                                    ...
                                    List<TradingGetDispute> disputeList = iTradingGetDispute.selectGetDisputeByTransactionId(userCases.getEbayId(),dispute.getTransactionid());
                                    ...
                                    dispute.setEbayId(userCases.getEbayId());
