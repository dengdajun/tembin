...
/**转换分类属性xml*/
    public static void zhSpec(String res) throws Exception {
        SAXReader reader = new SAXReader();
        reader.addHandler("/GetCategorySpecificsResponse/Recommendations",new MyElementHandler());
        Document document = reader.read(new ByteArrayInputStream(res.getBytes("UTF-8")));
        /*Document document= SamplePaseXml.formatStr2Doc(res);
        Element rootElt = document.getRootElement();
        Element el = rootElt.element("Recommendations");
