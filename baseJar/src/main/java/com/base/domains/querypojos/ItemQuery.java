...
public class ItemQuery extends TradingItem{
    ...
    private String timerCheckFlag;

    private String timerFlag;

    public String getTimerCheckFlag() {
        return timerCheckFlag;
    }

    public void setTimerCheckFlag(String timerCheckFlag) {
        this.timerCheckFlag = timerCheckFlag;
    }
