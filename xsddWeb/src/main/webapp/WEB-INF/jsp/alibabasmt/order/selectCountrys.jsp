...
<head>
    ...
    <script type="text/javascript">
        ...
        function selectCountry(name,countryId){
            var url=path+"/SMTorder/selectCountry.do?countryId="+countryId;
            $().invoke(url,null,
                    [function(m,r){
                        var table="&nbsp;<table>";
                        var checkbox="";
                        ...
                        for(var i=0;i< r.length;i++){
                            var td="<td width='8%'><input type='checkbox' value='"+r[i].value+"' value1='"+r[i].name+"'value2='${root}"+r[i].imgurl+"'><span><img style='vertical-align: baseline;' src='${root}"+r[i].imgurl+"'><span style='vertical-align: text-bottom;'>"+r[i].name+"</span></span></td>";
                            ...
                            for(var j=0;j<names.length;j++){
                                if(names[j]==r[i].value){
                                    td="<td width='8%'><input type='checkbox' checked value='"+r[i].value+"' value1='"+r[i].name+"'value2='${root}"+r[i].imgurl+"'><span'><img style='vertical-align: baseline;' src='${root}"+r[i].imgurl+"'><span style='vertical-align: text-bottom;'>"+r[i].name+"</span></span></td>";
                                }
                            }
                            if(i%8==0){
                                checkbox+="<tr>"
