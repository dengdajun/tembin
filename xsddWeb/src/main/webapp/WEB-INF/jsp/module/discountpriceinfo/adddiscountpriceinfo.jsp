...
<head>
    ...
    <script>
        $(document).ready(function() {
            ...
            if(${(dis.madeforoutletcomparisonprice!=""&&dis.madeforoutletcomparisonprice!="0.0")||(dis.minimumadvertisedprice!=""&&dis.minimumadvertisedprice!="0.0")}){
                ...
                if(madeforoutletcomparisonprice!=""&&madeforoutletcomparisonprice!=null&&madeforoutletcomparisonprice!="0.0"){
                    $("input[name='a1'][value='a1']").prop("checked",true);
                    $("input[name='a1']").attr("disabled",false);
                    $("#MadeForOutletComparisonPrice").attr("disabled",false);
                }
                if(minimumadvertisedprice!="" && minimumadvertisedprice!=null&& minimumadvertisedprice!="0.0"){
    ...
    <form class="form-horizontal" role="form" id="discountPriceInfoForm">
        <table width="90%" border="0" style="margin-left:40px;">
            ...
            <tr>
                ...
                <td height="28">
                    <select name="ebayAccount" style="width: 300px;">
            ...
            <tr>
                ...
                <td width="87%" height="28"><br>
                    <input type="checkbox" id="selectflag" name="selectflag" value="1">价格折扣（不包括拍卖物品）<br>
                    <input type="radio" name="a1" value="a1">在原价上给予折扣<input type="text" id="MadeForOutletComparisonPrice"  class="newintput validate[custom[number]]" style="width: 40px;" name="MadeForOutletComparisonPrice" value="${dis.madeforoutletcomparisonprice}" size="10">%<br>
