...
<head>
    ...
    <script type="text/javascript">
        ...
        function submitCommit(){
            ...
            var countrys=W.document.getElementById("selectCountrys");
            var countryIds1=W.document.getElementById("countryIds");
            var autoMessageId= W.document.getElementById("id");
            var flag="false";
            if($(countrys).val()!="指定国家"){
                flag="true";
            }
            if(aountryText!=""){
                var url=path+"/autoMessage/ajax/saveCountry.do?autoMessageId="+$(autoMessageId).val()+"&flag="+flag;
