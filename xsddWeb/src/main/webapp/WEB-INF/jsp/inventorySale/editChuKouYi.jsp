...
<head>
    ...
    <script type="text/javascript">
        ...
        function submitCommit(){
            if(!$("#ChuKouYiForm").validationEngine("validate")){
                return;
            }
            var url=path+"/inventorySale/ajax/saveChuKouYi.do";
            var data=$("#ChuKouYiForm").serialize();
            $().invoke(url,data,
                    [function(m,r){
                        alert(r);
                        W.inventorySale.close();
        ...
        $(document).ready(function(){
            $("#ChuKouYiForm").validationEngine();
        });
    </script>
</head>
<body>
<form id="ChuKouYiForm">
    <br/><br/>
