...
<head>
    ...
    <script type="text/javascript">
        ...
        %>
        var path='<%=rootPath%>';
        var isMainAccount='${isMainAccount}';
        var ebaySize="${ebaysCount}";
    </script>
    <!-- bootstrap -->
...
<div class="new_index" style="padding-left: 5px">
    ...
    <a href="<c:url value ="/order/getOrdersList.do?onFlag=main"/>">
...
<li><span class="newusa_iv">选择账户</span><a href="javascript:void(0)"><span class="newusa_ici" name="amount" onclick="selectAmount(0,null);">全部</span></a>
    <c:forEach items="${ebays}" var="ebay" begin="0" varStatus="status">
        <a href="javascript:void(0)"><span class="newusa_ici_1" name="amount" onclick="selectAmount(${status.index+1},'${ebay.id}');">${ebay.ebayNameCode}<%--TO(eBay)--%></span></a>
    </c:forEach>
</li>
<li><span class="newusa_iv">选择时间</span><a href="javascript:void(0)"><span class="newusa_ici" name="time" onclick="selectTime(0,'15')">15天内</span></a><a href="javascript:void(0)"><span class="newusa_ici_1" name="time" onclick="selectTime(1,'30')">30天内</span></a><a  href="javascript:void(0)" ><span name="time" onclick="selectTime(2,'1')" class="newusa_ici_1">1年内</span></a></li>
<div class="ico_list">
