...
public class UtilController extends BaseAction{
    ...
    public void getCategorySpecifics(String parentCategoryID,HttpServletRequest request,String siteID) throws Exception {
        ...
        for(PublicDataDictCategorySpecifics pd:publicDataDictList){
            pd.setItemEnName(HtmlUtils.htmlEscape(pd.getItemEnName()));
        }
    ...
    public void getReseCategoryMenu(ModelMap modelMap,String title,String siteid,CommonParmVO commonParmVO) throws Exception {
        ...
        if(!r1.equals("fail")){
            ...
            if ("Success".equalsIgnoreCase(ack) || "Warning".equalsIgnoreCase(ack)) {
                litr = SamplePaseXml.selectCategoryByKey(res,tdd);
            }
        }
...
/*        Map m = new HashMap();
    ...
    @ResponseBody
    public void saveReseCategory(ModelMap modelMap,HttpServletRequest request,HttpServletResponse response) throws Exception {
        String id = request.getParameter("id");
  /*      TradingReseCategory tradingReseCategory = new TradingReseCategory();
        tradingReseCategory.setCategoryId(request.getParameter("categoryId"));
        tradingReseCategory.setCategoryKey(HtmlUtils.htmlEscape(request.getParameter("categoryKey")));
        tradingReseCategory.setCategoryName(request.getParameter("siteId"));
        tradingReseCategory.setIsFlag("0");
        this.iTradingReseCategory.saveTradingReseCategory(tradingReseCategory);
*/
        AjaxSupport.sendSuccessText("", "{\"pathstr\":\""+this.getStr(request.getParameter("categoryId"))+"\"}");
    }
    ...
    public ModelAndView initSelectCategoryPage(@ModelAttribute( "initSomeParmMap" )ModelMap modelMap,HttpServletRequest request){
        modelMap.put("doType",request.getParameter("doType"));
...
/**商品类别相关结束==========================================================*/
    ...
    /*调用ＡＰＩ抓取数据*/
    @RequestMapping("category/saveShipptingLoction.do")
    @ResponseBody
    public ModelAndView saveShipptingLoction(ModelMap modelMap, HttpServletRequest request) throws Exception {
        String xml="<?xml version=\"1.0\" encoding=\"utf-8\"?>\n" +
                "<GeteBayDetailsRequest xmlns=\"urn:ebay:apis:eBLBaseComponents\">\n" +
                "  <RequesterCredentials>\n" +
        ...
        List<TradingDataDictionary> litdds = DataDictionarySupport.getTradingDataDictionaryByType("site");

        for(TradingDataDictionary td:litdds){
            ...
            headers.add(new BasicHeader("X-EBAY-API-SITEID",td.getName1()));
            ...
            List<TradingDataDictionary> litddabc = SamplePaseXml.saveShipptingtoCounty(res,td.getId());
            for (TradingDataDictionary tdddesc : litddabc) {
    ...
    /*调用ＡＰＩ抓取数据*/
    @RequestMapping("category/saveReturnPolicy.do")
    @ResponseBody
    public ModelAndView saveReturnPolicy(ModelMap modelMap, HttpServletRequest request) throws Exception {
        String xml="<?xml version=\"1.0\" encoding=\"utf-8\"?>\n" +
                "<GeteBayDetailsRequest xmlns=\"urn:ebay:apis:eBLBaseComponents\">\n" +
                "  <RequesterCredentials>\n" +
                "    <eBayAuthToken>AgAAAA**AQAAAA**aAAAAA**vVcRVA**nY+sHZ2PrBmdj6wVnY+sEZ2PrA2dj6wFk4GhCpGGoA+dj6x9nY+seQ**cx0CAA**AAMAAA**</eBayAuthToken>" +
        ...
        for(TradingDataDictionary td:litdds){
            ...
            HttpClient httpClient= HttpClientUtil.getHttpsClient();
            String res= HttpClientUtil.post(httpClient, "https://api.sandbox.ebay.com/ws/api.dll", xml, "UTF-8", headers);
            List<TradingDataDictionary> litddabc = SamplePaseXml.saveReturnPolicy(res,td.getId());
            for (TradingDataDictionary tdddesc : litddabc) {
                this.iTradingDataDictionary.saveDataDictionary(tdddesc);
            }
        }
...
xml="<?xml version=\"1.0\" encoding=\"utf-8\"?>\n" +
    ...
    @RequestMapping("category/getCategoriesByID.do")
    @ResponseBody
    public ModelAndView getCategoriesByID(ModelMap modelMap, HttpServletRequest request,
                                          String sitNum,String categID,String sitID) throws Exception {
        String xml = "";
//category/getCategoriesByID.do?sitNum=0&sitID=311&categID
            ...
            xml = "<?xml version=\"1.0\" encoding=\"utf-8\"?>\n" +
                    ...
                    "<eBayAuthToken>AgAAAA**AQAAAA**aAAAAA**vVcRVA**nY+sHZ2PrBmdj6wVnY+sEZ2PrA2dj6wFk4GhCpGGoA+dj6x9nY+seQ**cx0CAA**AAMAAA**</eBayAuthToken>\n" +
                    "</RequesterCredentials>\n" +
                    "<CategorySiteID>" + sitNum + "</CategorySiteID>\n" +
                    "<DetailLevel>ReturnAll</DetailLevel>\n" +
                    "<CategoryParent>"+categID+"</CategoryParent>" +
                    "<ViewAllNodes>true</ViewAllNodes>" +
                    "</GetCategoriesRequest>​";
            List<BasicHeader> headers = new ArrayList<BasicHeader>();
            headers.add(new BasicHeader("X-EBAY-API-COMPATIBILITY-LEVEL", "885"));
            ...
            headers.add(new BasicHeader("X-EBAY-API-APP-NAME", "sandpoin-1f58-4e64-a45b-56507b02bbeb"));
            headers.add(new BasicHeader("X-EBAY-API-CERT-NAME", "936fc911-c05c-455c-8838-3a698f2da43a"));
            headers.add(new BasicHeader("X-EBAY-API-SITEID", sitNum));
            headers.add(new BasicHeader("X-EBAY-API-CALL-NAME", APINameStatic.GetCategories));
            HttpClient httpClient = HttpClientUtil.getHttpsClient();
            String res = HttpClientUtil.post(httpClient, "https://api.sandbox.ebay.com/ws/api.dll", xml.toString(), "UTF-8", headers);
            List<PublicDataDict> litdd = SamplePaseXml.selectPublicDataDict(res);
            for (PublicDataDict pdd : litdd) {
                pdd.setSiteId(sitID);
                if (pdd.getItemId().equalsIgnoreCase(pdd.getItemParentId())){
                    pdd.setItemParentId("0");
                }
                try {
    ...
    @ResponseBody
    public String getCategoriesSpec(ModelMap modelMap, HttpServletRequest request,
                                    String caID,String siteID
    ) throws Exception {
//http://localhost:8080/xsddWeb/category/getCategoriesSpec.do?caID=180235&siteID=311还需要改DownEbayFile.zhSpec中的站点id
        //DownEbayFile.main(null);fff
...
i++;
            ...
            String xml="<?xml version=\"1.0\" encoding=\"utf-8\"?>" +
                    ...
                    "<eBayAuthToken>AgAAAA**AQAAAA**aAAAAA**vVcRVA**nY+sHZ2PrBmdj6wVnY+sEZ2PrA2dj6wFk4GhCpGGoA+dj6x9nY+seQ**cx0CAA**AAMAAA**</eBayAuthToken>\n" +
                    "</RequesterCredentials>" +
                    "<CategoryID>"+caID+"</CategoryID>" +
                    "</GetCategorySpecificsRequest>​";

            TradingDataDictionary t= DataDictionarySupport.getTradingDataDictionaryByID(Long.valueOf(siteID));
    ...
    public ModelAndView userSelectSite(ModelMap modelMap,HttpServletRequest request){
        ...
        if(ebayList==null||ebayList.size()==0){
            if(systemUserManagerService.isAdminRole()&&c.getParentId()==0){
                return forword("/userinfo/ebayAccountManager",modelMap);
            }else{
                modelMap.put("isFlag","1");
    ...
    @RequestMapping("keymove/keyMoveErrorList.do")
    public ModelAndView keyMoveErrorList(ModelMap modelMap,HttpServletRequest request){
        String id = request.getParameter("id");
        modelMap.put("pressid",id);
        return forword("/userselect/keymoveerrorlist",modelMap);
    }
     ...
     * @throws Exception
     */
    @RequestMapping("keymove/getKeyMoveErrorList.do")
    @ResponseBody
    public void getKeyMoveErrorList(ModelMap modelMap, HttpServletRequest request,CommonParmVO commonParmVO) throws Exception {
        ...
        for(KeyMoveListWithBLOBs km:likml){
            km.setPaypalId(this.iUsercontrollerEbayAccount.selectById(Long.parseLong(km.getPaypalId())).getEbayName());
        }
        jsonBean.setTotal((int)page.getTotalCount());
        jsonBean.setList(likml);
        AjaxSupport.sendSuccessText("", jsonBean);
    }
    ...
    public void saveItemToLocation(ModelMap modelMap, HttpServletRequest request) throws Exception {
        ...
        Asserts.assertTrue(userId!=null,"未选择需要搬家的ebay账号！");
        for(String id : userId){
            ...
            taskMessageVO.setMessageContext("一键搬家执行结果");
            taskMessageVO.setMessageTitle("一键搬家消息通知");
            ...
            taskMessageVO.setObjClass(new String[]{uea.getEbayAccount(),uea.getEbayToken(),sitedata.getName1(), sessionVO.getId()+"",sitedata.getId()+"",id});
    ...
    @RequestMapping("test/toIframe.do")
    public ModelAndView toIframe(@ModelAttribute( "initSomeParmMap" )ModelMap modelMap,HttpServletRequest request){
        return forword("/test/iframetest",modelMap);
    }
     ...
     * @throws Exception
     */
    @RequestMapping("/dayTask.do")
    @ResponseBody
    public void dayTask(ModelMap modelMap, HttpServletRequest request) throws Exception {
        SessionVO c= SessionCacheSupport.getSessionVO();
        MainTask mainTask = (MainTask) ApplicationContextUtil.getBean(MainTask.class);
        mainTask.doItEveryDay();
