...
public class FeedBackController extends BaseAction {
    ...
    @ResponseBody
    public void saveFeedBackAll(ModelMap modelMap,CommonParmVO2 commonParmVO) throws Exception {
    ...
    @ResponseBody
    public void getFeedBackReportList(ModelMap modelMap,CommonParmVO2 commonParmVO) throws Exception {
    ...
    @ResponseBody
    public void getCountSize(ModelMap modelMap, CommonParmVO2 commonParmVO, HttpServletRequest request, HttpServletResponse response) throws Exception {
        ...
        String path="http://www.tembin.com/xsddWeb/img/";
        String outStr = "<table style='width: 100%;'>";
        if(tradingItemWithBLOBs!=null) {
            if ("1".equals(tradingItemWithBLOBs.getAssessSetview())) {
                outStr += "<tr><td><div  style='text-align: center;'>PositiveSize:" + PositiveSize + "</div></td></tr>";
            } else {
                outStr += "<tr><td><div style='text-align: center;'><img src='"+path+"new_one_1.gif' style='vertical-align: bottom;'/>PositiveSize:" + PositiveSize + " | <img src='"+path+"new_one_2.gif'  style='vertical-align: bottom;'/>Neutral:" + NeutralSize + " | <img src='"+path+"new_one_3.gif'  style='vertical-align: bottom;'/>Negative:" + NegativeSize + "</div></td></tr>";
            }
        }
        outStr+="</table>";
    ...
    @ResponseBody
    public void getItemReportList(ModelMap modelMap,CommonParmVO2 commonParmVO) throws Exception {
