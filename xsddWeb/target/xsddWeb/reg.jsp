...
<title>注册</title>
    ...
    <script type="text/javascript">
        ...
        function vailForm(){
            ...
            if(/.*[\u4e00-\u9fa5]+.*$/.test($("#userEmail").val()))
            {
                alert("不能含有汉字！");
                return false;
            }
            if(/[^\x00-\xff]/ig.test($("#userEmail").val())){
                alert("不能含有全角");
                return false;
            }
...
<form id="regForm" method="post">
    ...
    <li style="margin-bottom:20px">
        <input title="输入密码" name="userPassword" type="password" class="admin_user_input_y aemail_4"
               id="pword1" value=""  /></li>
    <li style="margin-bottom:10px">
        <input title="确认输入密码" name="psw2" type="password" class="admin_user_input_y aemail_5" id="pword2" value="" /></li>
    <li style="margin-bottom:10px">
        <input name="yqm" type="text" class="admin_user_input_y aemail_5" id="yqm" value="邀请码(可不填)" onfocus="if(this.value=='邀请码(可不填)'){this.value='';}"  onblur="if(this.value==''){this.value='邀请码(可不填)';}" /></li>
    ...
    <li style="height:65px;">
        ...
        <a href="#"></a> <a href="#"></a><div style="color: #ff2222">注册后请加客服qq群：244373066</div></li>
