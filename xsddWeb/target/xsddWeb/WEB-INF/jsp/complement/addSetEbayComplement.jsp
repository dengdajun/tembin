    ...
    <form class="form-horizontal" role="form" id="payPalForm">
        <table width="90%" border="0" style="margin-left:40px;">
            <tr>
                ...
                <td height="28">
                    <select name="complementType" width="300px;" onchange="showRemark(this);">
...
<div>
    <span id="auto1" style="padding-left: 100px;color: darkred;">说明：自动补数是维持物品现有数量不变</span>
    <span id="auto2" style="display: none;padding-left: 100px;color: darkred;">说明：库存补数是根据物品现在（库存数量）可用数量进行补数</span>
</div>
