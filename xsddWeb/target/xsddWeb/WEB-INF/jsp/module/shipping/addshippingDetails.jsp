    ...
    <script>
        ...
        * @param obj
        ...
        function createInterTables(obj1,obj2,obj3){
            ...
            intertable +=' <td> ';
            intertable +=' <select name="ShippingService" shortName="a2"> ';
        ...
        function setInter(parentId){
            ...
            $().invoke(
                    ...
                    [function (m, r) {
                        ...
                        for(var i = 0;i< r.length;i++){
                            interShippingService +='<option value="'+r[i].id+'">'+r[i].name+'</option>';
                        }
        ...
        $(document).ready(function() {
            ...
            setTimeout(function(){
                ...
                <c:forEach var="obj" items="${litio}" varStatus="ind">
                $("select[name='ShippingService'][shortName='a2']").each(function(i,d){
                    if('${ind.index}'==i){
                        $(d).find("option[value='${obj.shippingservice}']").attr("selected",true);
                    }
