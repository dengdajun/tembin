...
<head>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            $("#autoMessageTable").initTable({
                ...
                columnData:[
                    ...
                    {title:"类型",name:"type",width:"8%",align:"left",format:makeOption22},
        ...
        function makeOption22(json){
            if(json.type=='paidAutoMessage'){
                return "收到买家付款";
            }
            if(json.type=='shippedAutoMessage'){
                return "标记已发货";
            }
            if(json.type=='goodReviewAutoMessage'){
                return "收到买家的正评";
            }
            if(json.type=='mediumReviewAutoMessage'){
                return "收到买家的中评";
            }
            if(json.type=='shippedAutoMessage'){
                return "收到买家的负评";
