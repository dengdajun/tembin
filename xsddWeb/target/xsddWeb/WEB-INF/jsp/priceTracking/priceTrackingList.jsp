...
<head>
    ...
    <script type="text/javascript">
        ...
        function query(){
            var qeuryContent=$("#qeuryContent").select2("data")!=null?$("#qeuryContent").select2("data").text:"";
            if(qeuryContent!=""){
                qeuryContent = qeuryContent.trim();
            }
...
<select id="selectName" name="type"  onchange="chageOldDom(this)" style="color: #737FA7;width: 80px;float: left">
    ...
    <div class="vsearch">
        <input id="qeuryContent" name="conteny" type="text"  style="width:200px;float: left"  multiple class="multiSelect"><input onclick="query();" style="display: none;" name="newbut" type="button" class="key_2"></div>
</div>
    <div class="newds">
