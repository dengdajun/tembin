...
<head>
    ...
    <link href="<c:url value ="/js/kfservice/css/public_index.css"/>" rel="stylesheet"/>

    <script type="text/javascript" src=<c:url value ="/js/batchAjaxUtil.js" /> ></script>
    <script type="text/javascript" src=<c:url value ="/js/commonPage/mainframe/mainFramePage.js" />${jsfileVersion} ></script>
    <link rel="stylesheet" type="text/css" href="<c:url value ="/js/toolTip/css/toolTip.css"/> "/>
    <script type="text/javascript" src=<c:url value ="/js/toolTip/js/toolTip.js" />${jsfileVersion} ></script>
    ...
    <script type="text/javascript" src=<c:url value ="/js/kfservice/js/feedback_util.js" />${jsfileVersion} ></script>
    ...
    <script type="text/javascript">
        ...
        function setWandH(){//设置宽度
            ...
            //console.log(oldHei_+"=")
            if(oldHei_!='' && oldHei_>=wi.eHeight){
                return;
            }
            oldHei_=wi.eHeight;
//console.log(oldHei_+"=="+wi.eHeight)
...
<header   class="navbar navbar-inverse" style="position: absolute;width: 100%;" role="banner">
    ...
    <ul class="nav navbar-nav pull-right hidden-xs">
        ...
        <li title="帮助文档" class="settings hidden-xs hidden-sm tooltips" tooltip="帮助文档"
            tooltip-type="primary" tooltip-position="bottom">
            <a onclick="helpPage()" href="javascript:void(0)" role="button">
                <i class="">??</i>
            </a>
        </li>
...
<div class="box_os">
    <div class="os_x"></div>
    <div class="osqq">
        <p><em>(工作日：9:30-18:00)</em></p>
       <%-- <p><strong>在线QQ</strong></p>
        <p id="ico_onlineqq" class="qq"></p>--%>
        <%--<p><strong>客服电话</strong><span>000-0000000</span><span>000-0000000</span></p>--%>
    </div>
    <div class="acbox">
        <a class="ico_pp" onclick="FeedbackUtil.feed('/sitemessage/ajax/feedBackMessage.do');" href="javascript:void(0);" title=""></a>
...
<script type="text/javascript" src=<c:url value ="/js/kfservice/js/onlineService20130718.js" /> ></script>
</body>
