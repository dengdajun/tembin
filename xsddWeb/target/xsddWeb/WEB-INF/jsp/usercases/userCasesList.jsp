    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            $("#UserCasesListTable").initTable({
                ...
                columnData:[
                    {title:"商品图片",name:"pic",width:"6%",align:"left",format:makeOption50,click:rowClickMethod},
                    ...
                    {title:"卖家ID",name:"sellerid",width:"8%",align:"left",click:rowClickMethod},
                    {title:"买家ID",name:"buyerid",width:"8%",align:"left",click:rowClickMethod},
                    {title:"状态",name:"status",width:"8%",align:"left",format:makeOption51,click:rowClickMethod},
        ...
        function makeOption51(json){
            if(json.caseStatusValue&&json.caseStatusValue!=""){
                return json.caseStatusValue;
            }else{
                return json.status;
            }
        }
        function rowClickMethod(json){
            ...
            if(json.status.indexOf("CLOSED")>-1){
                viewCaseDetails(json.transactionid,json.ebayId);
            }else{
                handleDispute(json.transactionid,json.ebayId,json.itemid);
            }
        }
        ...
        function makeOption1(json){
           ...
           /* var htm="<div class=\"ui-select\" style=\"width:106px\" >" +
            ...
            var hs="";
            if(json.status.indexOf("CLOSED")>-1){
                hs+="<li style=\"height:25px;\" onclick=selectOperation('"+json.transactionid+"','"+json.id+"','"+json.ebayId+"',this,'"+json.itemid+"'); value='4' doaction=\"readed\" >查看详情</li>";
            }else{
                hs+="<li style=\"height:25px;\" onclick=selectOperation('"+json.transactionid+"','"+json.id+"','"+json.ebayId+"',this,'"+json.itemid+"'); value='3' doaction=\"readed\" >处理纠纷</li>";
                hs+="<li style=\"height:25px;\" onclick=selectOperation('"+json.transactionid+"','"+json.id+"','"+json.ebayId+"',this,'"+json.itemid+"'); value='4' doaction=\"look\" >查看详情</li>";
            }
            var pp={"liString":hs};
            return "<div align='center' style='width: 100%'>"+getULSelect(pp)+"</div>";
        }
        function selectOperation(transactionid,id,sellerid,obj,itemid){
            ...
            if(value=="3"){
                handleDispute(transactionid,sellerid,itemid);
            }
            if(value=="4"){
                viewCaseDetails(transactionid,sellerid);
            }
        }
        function viewCaseDetails(transactionid,ebayId){
            var url=path+"/userCases/viewCaseDetails.do?transactionid="+transactionid+"&ebayId="+ebayId;
            CaseDetails=openMyDialog({title: '纠纷详情',
                content: 'url:'+url,
                icon: 'succeed',
                width:800,
                height:600,
        ...
        function makeOption50(json){
            var   htm1="<img onerror='nofind();' src='${itemListIconUrl}"+json.itemid+".jpg' style='width: 50px;height:50px;' />";
            return htm1;
        }
        function makeOption2(json){
            ...
            var htm="<a target=\"_blank\" href=\"${serviceItemUrl}"+json.itemid+"\">"+detail+"("+json.itemid+")</a>";
            return htm;
        }
        ...
        function viewDetails(id,ebayId){
            var url=path+"/userCases/viewDetails.do?transactionid="+id+"&ebayId="+ebayId;
        ...
        function handleDispute(id,ebayId,itemid){
            ...
            var url=path+"/userCases/responseDispute.do?transactionid="+id+"&ebayId="+ebayId+"&itemId="+itemid;
        ...
        function submitCommit(){
            ...
            var content=$("#qeuryContent").select2("data")!=null?$("#qeuryContent").select2("data").text:"";
        ...
        function initSearchInput(bs){
            ...
            mySelect2I([{url:_url,doitAfterSelect:submitCommit,
                data:{currInputName:"content"},bs:"#qeuryContent",multiple:false,maping:_map}]);
        }
    </script>
...
<div class="Contentbox">
    ...
    <div class="new_tab_ls">
        <dt id="menu1" class="new_tab_1">CASE</dt>
    </div><br/><br/><br/>
    <div class="new_usa">
        ...
        <li class="new_usa_list"><span class="newusa_i" style="width: 75px;">选择账号：</span>
            ...
            <c:forEach items="${ebays}" var="ebay" begin="0" varStatus="status">
                <a href="javascript:void(0)"><span scop="account" onclick="selectAccount('${ebay.ebayName}',${status.index+1});" class="newusa_ici_1">${fn:toUpperCase(ebay.ebayNameCode)}</span></a>
            </c:forEach>
...
<select id="selectName" name="type" onchange="chageOldDom(this)" style="color: #737FA7;width: 80px;float: left">
    ...
    <option value="4">卖家</option>
            ...
            <div class="vsearch">
                <input id="qeuryContent" name="" type="text"  style="width:200px;float: left"  multiple class="multiSelect"><input onclick="submitCommit();" style="display: none;" name="newbut" type="button" class="key_2"></div>
        </div>
        <div class="newds">
