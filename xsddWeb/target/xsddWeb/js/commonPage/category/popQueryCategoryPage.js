...
function que(){
    ...
    if(selectFlag=="radio"){
        var url=path+"/ajax/saveReseCategory.do?categoryId="+_finalSelectedVal+"&categoryName="+$("#menuPath").text()+"&categoryKey="+$("#title").val();
        var sitId=$(W.document.getElementsByName("site")).eq(0).val();
        ...
        $().invoke(url,data,
            [function(m,r) {
                ...
                if (doType == "1") {
                    ...
                    W.document.getElementById("SecondaryCategory").value = _finalSelectedVal;
                    W.document.getElementById("SecondaryCategoryshow").innerHTML = rr.pathstr;
                }
        ...
        if (doType == "1") {
            ...
            W.document.getElementById("SecondaryCategory").value = _finalSelectedVal;
            W.document.getElementById("SecondaryCategoryshow").innerHTML = $("#menuPath").text();
        }
        W.CategoryType.close();
    }
}
