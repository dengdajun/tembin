...
//<script type="text/javascript">
    ...
    var hz = ".com";
    var fz0 = "www.tembin.com/xsddWeb/js/jquery/jquery-1.9.0.min.js";
...
function getShowData(){
    var urll="http://task.tembin.com:8080/xsddWeb/"+"/ajax/getCountSize.do";
