...
<div class="admin_user_reg">
    <ul>
        ...
        <li id="loginUserIDl" style="margin-bottom:20px">
            <input name="loginUserID" id="loginUserID"
                   type="text" class="admin_user_input_y aemail_3"  value="你的帐号" onfocus="if(this.value=='你的帐号'){this.value='';}"  onblur="if(this.value==''){this.value='你的帐号';}" />
        </li>
        <li id="safeCodel" style="margin-bottom:20px">
            <input name="sid" type="hidden" class="admin_user_input_y" id="sid" value=""
                    />
            <input name="safeCode" type="text" class="admin_user_input_y aemail_1" id="safeCode"
                   value="验证码" onfocus="if(this.value=='验证码'){this.value='';}"  onblur="if(this.value==''){this.value='有验证码';}" />
        </li>
        <li id="pwd1l" style="margin-bottom:20px">
            <input name="newPWD" type="text" class="admin_user_input_y aemail_4" id="pwd1" value="新密码" onfocus="if(this.value=='新密码'){this.value='';}"  onblur="if(this.value==''){this.value='新密码';}" /></li>
        <li id="pwd2l" style="margin-bottom:10px">
            <input name="pwd2"  type="text" class="admin_user_input_y aemail_5" id="pwd2" value="确认密码" onfocus="if(this.value=='确认密码'){this.value='';}"  onblur="if(this.value==''){this.value='确认密码';}" /></li>
        <li id="spaninfo">
    ...
    <%--<ul>
        ...
        <form id="regForm" method="post">
            ...
            <li>
                <input name="loginUserID" type="text" class="admin_user_input_y" id="loginUserID" value=""
                        />
            </li>

            <li id="safeCodel" style="height: 15px;margin-top: 5px">邮箱验证码</li>
            <li>
                <input name="safeCode" type="text" class="admin_user_input_y" id="safeCode" value=""
                        />
                <input name="sid" type="hidden" class="admin_user_input_y" id="sid" value=""
                        />
            </li>
            ...
            <li>
                <input name="newPWD" type="password" class="admin_user_input_y" id="pwd1" value=""
                        />
            </li>

            <li id="pwd2l" style="height: 15px;margin-top: 5px">确认新密码</li>
            <li>
                <input name="pwd2" type="password" class="admin_user_input_y" id="pwd2" value=""
                        />
            </li>
