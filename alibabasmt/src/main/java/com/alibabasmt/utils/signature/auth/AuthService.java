...
public class AuthService {
    ...
    /**根据code获取refreshToken和accessToken*/
    public static void fetchTokenByCode(SignatureVO signatureVO){
        String host = signatureVO.getHost();
        String client_id = signatureVO.getAppKey();
        String appSecret = signatureVO.getAppSecret();
        String redirect_uri = signatureVO.getRedirect_uri();

        Map<String, String> params1 = new HashMap<String, String>();
        params1.put("client_id", client_id);
        params1.put("redirect_uri", redirect_uri);
        params1.put("client_secret", appSecret);
        params1.put("code", signatureVO.getCode());
       ...
       // System.out.println("用临时令牌换取授权令牌的返回结果：" + getTokenResult);
        ...
        signatureVO.setRefreshToken(jsonObject.get("refresh_token").toString());
        signatureVO.setAccessToken(jsonObject.get("access_token").toString());
    }
    /**根据refreshtoken获取accesstoken,Accesstoken期限是10小时*/
    public static void getAccesstokenByrefresh(SignatureVO signatureVO){
        String host = signatureVO.getHost();
        String client_id = signatureVO.getAppKey();
        String appSecret = signatureVO.getAppSecret();
        String redirect_uri = signatureVO.getRedirect_uri();

        String refreshToken = signatureVO.getRefreshToken();
        ...
        signatureVO.setAccessToken(jsonObject1.get("access_token").toString());
    }
